...
const Header = () => {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-50 bg-background/85 backdrop-blur-md border-b-2 border-foreground/10", children: [
    /* @__PURE__ */ jsxs("div", { className: "container flex h-20 items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsx(Link, { to: "/", className: "flex items-center shrink-0", "aria-label": "Ottr Plumr Plumbing & Heating home", children: /* @__PURE__ */ jsx(
        "img",
        {
          src: logo$1,
      ...
      /* @__PURE__ */ jsx("nav", { className: "hidden md:flex items-center gap-1", "aria-label": "Primary", children: links.map((l) => /* @__PURE__ */ jsx(
        NavLink,
        {
          to: l.to,
          end: l.to === "/",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", size: "default", className: "hidden lg:inline-flex", children: /* @__PURE__ */ jsxs("a", { href: JOBBER_BOOK_URL, target: "_blank", rel: "noopener noreferrer", children: [
          /* @__PURE__ */ jsx(CalendarCheck, { className: "h-4 w-4" }),
          " Book Now"
        ] }) }),
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", size: "default", className: "hidden lg:inline-flex", children: /* @__PURE__ */ jsxs("a", { href: JOBBER_CLIENT_HUB_URL, target: "_blank", rel: "noopener noreferrer", children: [
          /* @__PURE__ */ jsx(UserCircle, { className: "h-4 w-4" }),
          " Client Hub"
        ] }) }),
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "hero", size: "default", className: "hidden sm:inline-flex", children: /* @__PURE__ */ jsxs("a", { href: `tel:${PHONE_TEL}`, "aria-label": `Call Ottr Plumr at ${PHONE_DISPLAY}`, children: [
    ...
    open && /* @__PURE__ */ jsx("div", { className: "md:hidden border-t-2 border-foreground/10 bg-card", children: /* @__PURE__ */ jsxs("nav", { className: "container py-4 flex flex-col gap-1", "aria-label": "Mobile", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2 mt-3", children: [
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxs("a", { href: JOBBER_BOOK_URL, target: "_blank", rel: "noopener noreferrer", children: [
          /* @__PURE__ */ jsx(CalendarCheck, { className: "h-4 w-4" }),
          " Book"
        ] }) }),
        ...
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "hero", className: "col-span-2", children: /* @__PURE__ */ jsxs("a", { href: `tel:${PHONE_TEL}`, children: [
          /* @__PURE__ */ jsx(Phone, { className: "h-4 w-4" }),
          " Call ",
          PHONE_DISPLAY
        ] }) })
...
const Footer = () => {
  return /* @__PURE__ */ jsxs("footer", { className: "mt-24", children: [
    /* @__PURE__ */ jsx("div", { className: "water-band h-10", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxs("div", { className: "bg-gradient-deep text-primary-foreground", children: [
      /* @__PURE__ */ jsxs("div", { className: "container py-14 grid gap-10 md:grid-cols-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("img", { src: logo, alt: "Ottr Plumr Plumbing & Heating logo — Welland, Ontario", width: 56, height: 56, loading: "lazy", decoding: "async", className: "h-14 w-14 rounded-xl bg-card p-1" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "font-display text-xl", children: "Ottr Plumr" }),
              /* @__PURE__ */ jsx("div", { className: "text-xs opacity-80", children: "Plumbing & Heating" })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "font-script text-2xl mt-4 text-primary-glow", children: "Otterly Reliable." }),
          /* @__PURE__ */ jsx("p", { className: "text-sm opacity-80", children: "Professional, start to finish." }),
          /* @__PURE__ */ jsx("p", { className: "text-xs opacity-60 mt-4", children: "A division of Canalside Mechanical LTD" })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-display text-base mb-3", children: "Explore" }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm opacity-90", children: [
            ...
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/services", className: "hover:underline", children: "Services" }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/service-areas", className: "hover:underline", children: "Service Areas" }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/blog", className: "hover:underline", children: "Blog" }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/about", className: "hover:underline", children: "About" }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { to: "/contact", className: "hover:underline", children: "Contact" }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", { href: JOBBER_BOOK_URL, target: "_blank", rel: "noopener noreferrer", className: "hover:underline inline-flex items-center gap-1", children: [
              /* @__PURE__ */ jsx(CalendarCheck, { className: "h-3.5 w-3.5" }),
              " Book Now"
            ] }) }),
            /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", { href: JOBBER_CLIENT_HUB_URL, target: "_blank", rel: "noopener noreferrer", className: "hover:underline inline-flex items-center gap-1", children: [
              /* @__PURE__ */ jsx(UserCircle2, { className: "h-3.5 w-3.5" }),
              " Client Hub"
            ] }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-display text-base mb-3", children: "Get in Touch" }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-3 text-sm", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("a", { href: `tel:${PHONE_TEL}`, className: "hover:underline", children: PHONE_DISPLAY })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4 mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("a", { href: `mailto:${EMAIL}`, className: "hover:underline", children: EMAIL })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4 mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsx("a", { href: GOOGLE_MAPS_URL, target: "_blank", rel: "noopener noreferrer", className: "hover:underline", children: ADDRESS_LINE })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 opacity-80", children: [
              /* @__PURE__ */ jsx("span", { className: "h-4 w-4 shrink-0", "aria-hidden": "true" }),
              /* @__PURE__ */ jsx("span", { children: "Serving every city in the Niagara Region" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-display text-base mb-3", children: "Hours" }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm opacity-90", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsx(Clock, { className: "h-4 w-4 mt-0.5 shrink-0" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "font-semibold", children: "24 / 7 Emergency Service" }),
                /* @__PURE__ */ jsx("div", { className: "opacity-80", children: "Always on call when you need us" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("li", { className: "pl-6", children: "Regular hours: Mon–Fri, 8 AM – 4 PM" }),
            /* @__PURE__ */ jsx("li", { className: "pl-6 opacity-80", children: "After-hours rates apply on evenings & weekends" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "border-t border-primary-foreground/15", children: /* @__PURE__ */ jsxs("div", { className: "container py-5 flex flex-col sm:flex-row gap-2 items-center justify-between text-xs opacity-80", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Canalside Mechanical LTD (Ottr Plumr). All rights reserved."
        ] }),
        /* @__PURE__ */ jsx("div", { children: "187 King St, Welland, ON L3B 3J4" })
      ] }) })
    ] })
  ] });
};
        ...
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("span", { className: "relative flex h-2.5 w-2.5", children: [
              /* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full rounded-full bg-accent-foreground opacity-75 animate-ping" }),
              /* @__PURE__ */ jsx("span", { className: "relative inline-flex rounded-full h-2.5 w-2.5 bg-accent-foreground" })
            ] }),
...
const Layout = () => {
  return /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx("main", { className: "flex-1 pb-20", children: /* @__PURE__ */ jsx(Suspense, { fallback: null, children: /* @__PURE__ */ jsx(Outlet, {}) }) }),
      /* @__PURE__ */ jsx(Footer, {}),
...
const FAQ = ({ injectSchema = true, schemaId = "faq-component-jsonld" }) => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "container py-20 md:py-24", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center max-w-2xl mx-auto mb-10", children: [
      /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "Got questions?" }),
      /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl text-primary mt-1", children: "Here's the answers" }),
      /* @__PURE__ */ jsx("p", { className: "text-foreground/75 mt-4", children: "The most common things Niagara homeowners and businesses ask us." })
    ] }),
    /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "max-w-3xl mx-auto stamp-card px-6 md:px-8", children: FAQS.map((item, i) => /* @__PURE__ */ jsxs(AccordionItem, { value: `item-${i}`, className: "border-foreground/10 last:border-0", children: [
      /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left font-display text-lg text-primary hover:no-underline", children: item.q }),
      /* @__PURE__ */ jsx(AccordionContent, { className: "text-foreground/80 text-base leading-relaxed", children: item.a })
    ] }, item.q)) })
  ] });
};
const JOBS = [
...
const BeforeAfterGallery = () => {
  return /* @__PURE__ */ jsxs("section", { className: "container py-20 md:py-24", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
      /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "Before & after" }),
      /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl text-primary mt-1", children: "Real jobs across Niagara" }),
      /* @__PURE__ */ jsx("p", { className: "text-foreground/75 mt-4", children: "A look at recent work — clean installs, no shortcuts." })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: JOBS.map((j) => /* @__PURE__ */ jsxs("article", { className: "stamp-card overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2", children: [
        /* @__PURE__ */ jsxs("div", { className: `relative aspect-square bg-gradient-to-br ${j.before} grid place-items-center`, children: [
          /* @__PURE__ */ jsx("span", { className: "absolute top-2 left-2 text-[10px] font-bold uppercase tracking-wider bg-foreground/80 text-card px-2 py-0.5 rounded-full", children: "Before" }),
          /* @__PURE__ */ jsx(Wrench, { className: "h-10 w-10 text-foreground/30", "aria-hidden": "true" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `relative aspect-square bg-gradient-to-br ${j.after} grid place-items-center`, children: [
          /* @__PURE__ */ jsx("span", { className: "absolute top-2 left-2 text-[10px] font-bold uppercase tracking-wider bg-accent text-accent-foreground px-2 py-0.5 rounded-full", children: "After" }),
          /* @__PURE__ */ jsx(Wrench, { className: "h-10 w-10 text-primary-foreground/70", "aria-hidden": "true" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "p-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-xs text-accent font-semibold uppercase tracking-wider", children: [
          j.service,
          " · ",
          j.city
        ] }),
        /* @__PURE__ */ jsx("h3", { className: "font-display text-lg text-primary mt-1 leading-tight", children: j.title })
      ] })
    ] }, j.title)) }),
    /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-foreground/50 mt-6", children: "Project photos coming soon — illustrations shown for layout." })
  ] });
};
const CITIES = [
  {
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-gradient-hero", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "container relative pt-16 pb-24 md:pt-24 md:pb-32 grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("h1", { className: "font-display text-5xl md:text-6xl lg:text-7xl text-primary leading-[0.95]", children: [
            "Niagara's local",
            /* @__PURE__ */ jsx("br", {}),
            "plumbing & heating",
            /* @__PURE__ */ jsx("br", {}),
            "you can ",
            /* @__PURE__ */ jsx("span", { className: "text-accent", children: "trust." })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "font-script text-3xl text-reed", children: "Otterly reliable. Professional, start to finish." }),
          /* @__PURE__ */ jsx("p", { className: "text-base md:text-lg text-foreground/80 max-w-xl", children: "No corporate call centres, no runaround — just your Niagara neighbours, ready to help with every plumbing and heating need. Water heaters, sump pumps, heating systems, and everything in between." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3", children: [
            ...
            /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", size: "lg", children: /* @__PURE__ */ jsxs(Link, { to: "/contact", children: [
              "Get a Quote ",
              /* @__PURE__ */ jsx(ArrowRight, {})
            ] }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 pt-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 bg-card border-2 border-foreground/10 rounded-full px-3 py-1.5 shadow-soft", children: [
              /* @__PURE__ */ jsx("div", { className: "flex text-accent", children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 fill-accent" }, i)) }),
              /* @__PURE__ */ jsx("span", { className: "font-display text-sm text-primary", children: "4.9/5" })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-sm text-foreground/70", children: "Trusted by Niagara homeowners & businesses" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "relative hidden lg:flex justify-center items-center", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -m-10 rounded-full bg-water/40 blur-3xl", "aria-hidden": "true" }),
          /* @__PURE__ */ jsx(
            "img",
            {
              src: heroOtter,
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute -bottom-6 left-1/2 -translate-x-1/2 w-40 h-10 rounded-full border-2 border-water-deep/60 animate-ripple", "aria-hidden": "true" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "water-band h-12 md:h-16", "aria-hidden": "true" })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "container py-20 md:py-28", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl text-primary mt-1", children: "Full-service plumbing & heating" })
        ] }),
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "deep", children: /* @__PURE__ */ jsxs(Link, { to: "/services", children: [
          "All services ",
          /* @__PURE__ */ jsx(ArrowRight, {})
        ] }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: services.map((s) => /* @__PURE__ */ jsxs("article", { className: "stamp-card p-6 group hover:-translate-y-1 transition-transform", children: [
        /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-xl bg-primary text-primary-foreground grid place-items-center mb-4 shadow-soft group-hover:bg-accent transition-colors", children: /* @__PURE__ */ jsx(s.icon, { className: "h-6 w-6" }) }),
        /* @__PURE__ */ jsx("h3", { className: "font-display text-xl text-primary mb-1", children: s.title }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground/75", children: s.desc })
      ] }, s.title)) })
    ] }),
    /* @__PURE__ */ jsx("section", { className: "container pb-8 md:pb-12", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1.3fr_1fr] gap-10 items-start", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "Why local matters" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-3xl md:text-4xl text-primary leading-tight", children: "A real Niagara plumber answers the phone — every time." }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 text-base md:text-lg leading-relaxed", children: "When you call Ottr Plumr, you reach a local technician — not a national call centre routing you to whoever bid lowest this month. We live in the Niagara Region, our shop is at 187 King St in Welland, and we know the housing stock here cold: century homes through downtown St. Catharines and Old Glenridge, post-war bungalows in Welland and Port Colborne, lakeside cottages in Crystal Beach and Sherkston, vineyard properties in Lincoln, and brand-new builds in Grimsby and the south end of Niagara Falls." }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 text-base md:text-lg leading-relaxed", children: "That local knowledge changes how we work. We know which neighbourhoods still have clay sewer laterals fighting tree roots every spring. We know which lakeshore streets need battery-backup sump pumps as a baseline. We know which 1990s subdivisions are hitting the 25-year mark on their original water heaters. We bring the right tools and the right plan on the first visit — not a parts run halfway through." }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80 text-base md:text-lg leading-relaxed", children: "And the way we work is simple: diagnose first, quote in writing, do the work clean, leave the place tidier than we found it. Every job warrantied. Every price upfront. Same-day service for most calls, 24/7 emergency response when something can't wait. No sales scripts, no fear-selling — and if we uncover something hidden mid-job, we stop and show you before we touch it, so you can decide how to move forward." })
      ] }),
      /* @__PURE__ */ jsxs("aside", { className: "stamp-card p-7 md:p-8 bg-gradient-hero", children: [
        /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "What you can expect" }),
        /* @__PURE__ */ jsx("h3", { className: "font-display text-2xl text-primary mt-1 mb-5", children: "Every Ottr Plumr call" }),
        ...
        ].map((item) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2.5", children: [
          /* @__PURE__ */ jsx("span", { className: "mt-1 h-2 w-2 rounded-full bg-accent shrink-0", "aria-hidden": "true" }),
          /* @__PURE__ */ jsx("span", { className: "text-foreground/85 text-sm md:text-base", children: item })
        ] }, item)) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("section", { className: "bg-gradient-deep text-primary-foreground py-20 md:py-28", children: /* @__PURE__ */ jsxs("div", { className: "container grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-primary-glow", children: "Why Ottr Plumr?" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl mt-1 mb-6", children: "Local pros. Honest work. No surprises." }),
        /* @__PURE__ */ jsx("ul", { className: "space-y-4 text-base", children: [
        ...
        ].map(([t, d]) => /* @__PURE__ */ jsxs("li", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "h-10 w-10 shrink-0 rounded-full bg-accent grid place-items-center font-display", children: "✓" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "font-display text-lg", children: t }),
            /* @__PURE__ */ jsx("div", { className: "opacity-80 text-sm", children: d })
          ] })
        ] }, t)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-card text-foreground rounded-[2rem] p-8 shadow-pop border-4 border-primary-foreground/10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsx("div", { className: "flex text-accent", children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: "h-5 w-5 fill-accent" }, i)) }),
          /* @__PURE__ */ jsx("span", { className: "font-display text-2xl text-primary", children: "4.9" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-foreground/60", children: "/ 5 average rating" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/80", children: "Real reviews from real Niagara customers — see what folks are saying about our work." })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("section", { className: "container py-20 md:py-24", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
        /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "Customer love" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl text-primary mt-1", children: "Don't take our word for it" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-5", children: REVIEWS.map((r) => /* @__PURE__ */ jsxs("article", { className: "stamp-card p-7 flex flex-col", children: [
        /* @__PURE__ */ jsx(Quote, { className: "h-8 w-8 text-accent mb-3" }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/85 flex-1", children: r.quote }),
        /* @__PURE__ */ jsxs("div", { className: "mt-5 pt-5 border-t border-foreground/10 flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("div", { className: "font-display text-primary", children: r.name }),
          /* @__PURE__ */ jsx("div", { className: "flex text-accent", children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 fill-accent" }, i)) })
        ] })
      ] }, r.name)) })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-gradient-hero py-20 md:py-24", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background via-background/60 to-background", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxs("div", { className: "container relative grid lg:grid-cols-2 gap-10 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
          /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "On the road" }),
          /* @__PURE__ */ jsxs("h2", { className: "font-display text-4xl md:text-5xl text-primary leading-tight", children: [
            "Spot us around the ",
            /* @__PURE__ */ jsx("span", { className: "text-accent", children: "Niagara Region" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-foreground/80 text-base md:text-lg max-w-xl", children: "Our service vans are out every day across the Niagara Region — ready to diagnose, repair, and get most jobs sorted on the spot. You'll spot us in your neighbourhood. Wave hi." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -m-6 rounded-full bg-water/30 blur-3xl", "aria-hidden": "true" }),
          /* @__PURE__ */ jsx(
            "img",
            {
              src: vanWrap,
    ...
    /* @__PURE__ */ jsx(BeforeAfterGallery, {}),
    /* @__PURE__ */ jsxs("section", { className: "container py-12 md:py-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center max-w-2xl mx-auto mb-10", children: [
        /* @__PURE__ */ jsx("p", { className: "font-script text-2xl text-accent", children: "Where we work" }),
        /* @__PURE__ */ jsx("h2", { className: "font-display text-4xl md:text-5xl text-primary mt-1", children: "Proudly serving the Niagara Region" }),
        /* @__PURE__ */ jsx("p", { className: "text-foreground/75 mt-4", children: "Every city, every town. If you're in Niagara, we're your local crew." })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-2", children: CITIES.map((city) => /* @__PURE__ */ jsx(
        Link,
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsx(Button, { asChild: true, variant: "deep", children: /* @__PURE__ */ jsxs(Link, { to: "/service-areas", children: [
        "All service areas ",
        /* @__PURE__ */ jsx(ArrowRight, {})
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsx(FAQ, { injectSchema: false }),
    /* @__PURE__ */ jsx("section", { className: "container pb-8", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[2rem] overflow-hidden bg-accent text-accent-foreground p-10 md:p-14 shadow-pop relative", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -right-10 -bottom-10 h-60 w-60 rounded-full bg-accent-foreground/10", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxs("div", { className: "relative grid md:grid-cols-[1fr_auto] gap-6 items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-3xl md:text-4xl", children: "Got a leak, a chill, or a project?" }),
          /* @__PURE__ */ jsx("p", { className: "opacity-90 mt-2", children: "Pick up the phone, book online, or send us a message — we'll be there." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsx(Button, { asChild: true, size: "lg", className: "bg-card text-primary hover:bg-card/90", children: /* @__PURE__ */ jsxs("a", { href: `tel:${PHONE_TEL}`, children: [
            /* @__PURE__ */ jsx(Phone, {}),
            " ",
            PHONE_DISPLAY
          ] }) }),
...
const Services = lazy(() => import("./assets/Services-1kg3gqQu.js"));
const Service = lazy(() => import("./assets/Service-C-LIW4KD.js"));
const ServiceCity = lazy(() => import("./assets/ServiceCity-DTEUlYFA.js"));
const ServiceAreas = lazy(() => import("./assets/ServiceAreas-DmuNbIN_.js"));
const ServiceArea = lazy(() => import("./assets/ServiceArea-C6SgYtbF.js"));
const About = lazy(() => import("./assets/About-CTwe6LkV.js"));
const Contact = lazy(() => import("./assets/Contact-C77s-tbm.js"));
const Nap = lazy(() => import("./assets/Nap-BIO4N5yH.js"));
const Blog = lazy(() => import("./assets/Blog-Cl0jrQ8X.js"));
const BlogPost = lazy(() => import("./assets/BlogPost-YsmriSZF.js"));
const NotFound = lazy(() => import("./assets/NotFound-CTMB8Tuu.js"));
const routes = [
  {
    path: "/",
    Component: Layout,
