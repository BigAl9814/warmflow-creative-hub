        ...
        <div className="container relative grid lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-5">
            ...
            <p className="text-foreground/80 text-base md:text-lg max-w-xl">
              Our service vans are out every day across the Niagara Region — ready to diagnose,
              repair, and get most jobs sorted on the spot. You'll spot us in your neighbourhood. Wave hi.
            </p>
